...
<script type="text/javascript" >
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用ZHS汽车出租系统。当前时间为： "+newDate+"　"+week;
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        //最新文章列表
        $.get("${pageContext.request.contextPath}/static/json/newsList.json",function(data){
            var hotNewsHtml = '';
            for(var i=0;i<5;i++){
                hotNewsHtml += '<tr>'
